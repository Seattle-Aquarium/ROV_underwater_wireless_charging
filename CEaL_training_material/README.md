...
- And pease see the BR guide [here](https://bluerobotics.com/learn/bluerov2-operation/#operation) regarding some basic ROV operational guidance, including the need to NOT let the battery voltage drop below **12.5V** -- **the battery will be damaged if it drops beneath 12.0V**.
